...
if($Test){
    ...
    & ssh $TargetHost "cd $Dest && timeout 5 python3 complete_pi_client.py --server https://everydayadvertise.com ; true"
} else {
...
"@
    ...
    if($LASTEXITCODE -eq 0){
        ...
        Write-Host "`n📟 To see Pi ID, check logs:" -ForegroundColor Cyan
