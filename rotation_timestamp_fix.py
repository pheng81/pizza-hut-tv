#!/usr/bin/env python3
"""
Fix Rotation Timestamps
Update the rotation metadata timestamps to current time
"""
import json
import time
import tempfile
...
with open('rotation_fix.py', 'w') as f:
    f.write(fix_script)

print("🔧 Rotation Fix Script Created")
print("📤 Upload this script to the server and run it to fix the rotation timestamp issue")
print("💡 This should resolve the sync video playlist problem")