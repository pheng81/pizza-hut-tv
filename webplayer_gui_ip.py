#!/usr/bin/env python3
"""
Pizza Hut TV - Pi GUI Client (IP Address Version)
Uses IP address instead of domain name for better compatibility
"""
...
class PizzaHutTVApp:
    def __init__(self, root):
        ...
        # Server configuration - using IP address for better Pi compatibility
        self.server_url = "http://172.67.166.34:5002"
    ...
    def create_link_code_step(self):
        ...
        # Instructions
        tk.Label(self.link_frame, 
                text="Please enter the 4-digit link code:", 
                font=('Arial', 12), 
                fg='#cccccc', 
    ...
    def create_store_code_step(self):
        ...
        # Instructions
        tk.Label(self.store_frame, 
                text="Please enter the store code:", 
                font=('Arial', 12), 
                fg='#cccccc', 
                bg='#0d0d0d').pack(pady=(0, 15))
